...
def update_aliens(ai_settings,screen,stats,sb,ship,aliens,bullets):
    """ Check if the fleet is at the edges,and then update the positions of all the aliens in the fleet."""
...
def get_number_rows(ai_settings,ship_height,alien_height):
    """Determie the number of rows of aliens that fit on the screen."""
